...
<div id="templatemo_wrapper">
	...
	<div id="templatemo_header">
	  <div id="site_title"><h1><a href="#" target="_parent">Free CSS Templates</a></h1></div>
        ...
        </div> <!-- end of templatemo_menu --></div> <!-- end of header --><!-- InstanceBeginEditable name="flash" --> <p></p><p></p><p></p><center><?php include("includes/banco_imag.php"); ?></center><!-- InstanceEndEditable -->
